...
public class SwerveModule {
    ...
    public double getAbsoluteEncoderRad(){
        var EncoderVoltageSignal = absoluteEncoder.getSupplyVoltage();
        var EncoderVoltage = EncoderVoltageSignal.getValue();

        double angle = EncoderVoltage / RobotController.getCurrent5V();
        angle *= 2.0 * Math.PI;
...
System.out.println("Encoders set!");
        ...
        turningEncoder.setPosition(getEncoderPosition());
    }
    public void Read(){

        SmartDashboard.putNumber("Encoder [" + absoluteEncoder.getDeviceID() + "]", getEncoderPosition());
    }
